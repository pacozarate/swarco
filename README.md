...
La version local actual es `4.1.24` con build cache `20260716-v4-1-24`. La version se muestra en la cabecera de la aplicacion.

Para evitar cache de modulos antiguos al probar cambios locales, abra:

```text
http://127.0.0.1:4173/?fresh=20260716-v4-1-24
```
