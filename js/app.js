import { can, isNuesoRole, ROLES } from "./authEngine.js?v=20260716-v4-1-14";
import { loadJson, readWorkbookFile } from "./importExcel.js?v=20260716-v4-1-14";
import { detectChange } from "./changeDetectionEngine.js?v=20260716-v4-1-14";
import { validateTables } from "./validators.js?v=20260716-v4-1-14";
import { getAllModelRoots, getDefaultConfiguration, getModelTrl, getModels, getOptionsByGroup, selectedRoots } from "./trlEngine.js?v=20260716-v4-1-14";
import { getTftDetails } from "./tftDataEngine.js?v=20260716-v4-1-14";
import { calculateLedPanel } from "./ledCalculationEngine.js?v=20260716-v4-1-14";
import { calculateMechanics } from "./mechanicsEngine.js?v=20260716-v4-1-14";
import { getMechanicalSubassemblies } from "./mechanicalSubassembliesEngine.js?v=20260716-v4-1-14";
import { explodeBom } from "./bomExplosionEngine.js?v=20260716-v4-1-14";
import { consolidateBom } from "./bomConsolidationEngine.js?v=20260716-v4-1-14";
import { calculateCosts } from "./costingEngine.js?v=20260716-v4-1-14";
import { defaultFormulas, formulaContextRows, mergeFormulas } from "./formulaEngine.js?v=20260716-v4-1-14";
import { downloadCsv, downloadJson } from "./exportResults.js?v=20260716-v4-1-14";
import { renderSidebar } from "./appRouter.js?v=20260716-v4-1-14";
import { bindHeader, renderHeader } from "../views/commonHeader.js?v=20260716-v4-1-14";
import { maintenanceView } from "../views/maintenanceView.js?v=20260716-v4-1-14";
import { modelSelectionView } from "../views/modelSelectionView.js?v=20260716-v4-1-14";
import { tftView } from "../views/tftView.js?v=20260716-v4-1-14";
import { ledView } from "../views/ledView.js?v=20260716-v4-1-14";
import { mechanicsView } from "../views/mechanicsView.js?v=20260716-v4-1-14";
import { bomView } from "../views/bomView.js?v=20260716-v4-1-14";
import { costingView } from "../views/costingView.js?v=20260716-v4-1-14";
import { formulasView } from "../views/formulasView.js?v=20260716-v4-1-14";

const app = document.querySelector("#app");
const appVersion = "4.1.14";
const appBuild = "20260716-v4-1-14";
