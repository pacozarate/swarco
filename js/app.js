import { can, isNuesoRole, ROLES } from "./authEngine.js?v=20260806-v4-1-47";
import { loadTableData, readWorkbookFile } from "./importExcel.js?v=20260806-v4-1-47";
import { detectChange } from "./changeDetectionEngine.js?v=20260806-v4-1-47";
import { validateTables } from "./validators.js?v=20260806-v4-1-47";
import { getAllModelRoots, getDefaultConfiguration, getModelTrl, getModels, getOptionsByGroup, selectedRoots } from "./trlEngine.js?v=20260806-v4-1-47";
import { getTftDetails } from "./tftDataEngine.js?v=20260806-v4-1-47";
import { calculateLedPanel } from "./ledCalculationEngine.js?v=20260806-v4-1-47";
import { calculateMechanics } from "./mechanicsEngine.js?v=20260806-v4-1-47";
import { getMechanicalSubassemblies } from "./mechanicalSubassembliesEngine.js?v=20260806-v4-1-47";
import { explodeBom } from "./bomExplosionEngine.js?v=20260806-v4-1-47";
import { consolidateBom } from "./bomConsolidationEngine.js?v=20260806-v4-1-47";
import { calculateCosts } from "./costingEngine.js?v=20260806-v4-1-47";
import { defaultFormulas, formulaContextRows, mergeFormulas } from "./formulaEngine.js?v=20260806-v4-1-47";
import { downloadCsv, downloadJson } from "./exportResults.js?v=20260806-v4-1-47";
import { renderSidebar } from "./appRouter.js?v=20260806-v4-1-47";
import { bindHeader, renderHeader } from "../views/commonHeader.js?v=20260806-v4-1-47";
import { maintenanceView } from "../views/maintenanceView.js?v=20260806-v4-1-47";
import { modelSelectionView } from "../views/modelSelectionView.js?v=20260806-v4-1-47";
import { tftView } from "../views/tftView.js?v=20260806-v4-1-47";
import { ledView } from "../views/ledView.js?v=20260806-v4-1-47";
import { mechanicsView } from "../views/mechanicsView.js?v=20260806-v4-1-47";
import { bomView } from "../views/bomView.js?v=20260806-v4-1-47";
import { costingView } from "../views/costingView.js?v=20260806-v4-1-47";
import { formulasView } from "../views/formulasView.js?v=20260806-v4-1-47";

const app = document.querySelector("#app");
const appVersion = "4.1.47";
const appBuild = "20260806-v4-1-47";
